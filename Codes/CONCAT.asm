...
mov [di], al     ; IN FOR LOOP cx will run automatically
inc di
loop reverse 
...
mov al,[si]
mov [bp],al
inc si           ; IN FOR LOOP cx will run automatically
inc bp
loop concat1
...
mov [bp],al
inc di
inc bp           ; IN FOR LOOP cx will run automatically
loop concat2 
